...
describe('AlbumTracks', () => {
  test('should exists', () => {
    expect(renderAlbumTracks).toBeDefined();
  });
  ...
  test('should return expected markup', () => {
    const div = document.createElement('div');
    renderAlbumTracks(data, div);

    expect(div.innerHTML).toEqual(markup);
  });

  test('should return expected markup with 1 or more items', () => {
    const div = document.createElement('div');
    renderAlbumTracks(data2, div);
