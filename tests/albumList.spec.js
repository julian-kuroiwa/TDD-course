...
describe('AlbumList', () => {
  test('should exist', () => {
    expect(renderAlbums).toBeDefined();
  });
  ...
  test('should create and append the markup given a correct data', () => {
    const div = document.createElement('div');
    renderAlbums(data, div);

    expect(div.innerHTML).toEqual(markup);
  });

  test('should create and append when more than 1 album', () => {
    const div = document.createElement('div');
    renderAlbums(data2, div);

    expect(div.innerHTML).toEqual(markup2);
  });
});
